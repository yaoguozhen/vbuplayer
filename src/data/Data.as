package data 
{
	...
	public class Data
	{
		...
		public static function getData(obj:Stage):Boolean
		{
			...
			var data:String='{"skin":"videoPlayerSkin.swf","submitURl":"http://localhost/vbuplayer/submit.asp","fms":"rtmp://localhost/vod/","streams":[{"type":"0","stream":"mp4:stream_yulan.f4v"},{"type":"1","stream":"mp4:stream_biaoqing.f4v"},{"type":"2","stream":"mp4:stream_gaoqing.f4v"},{"type":"3","stream":"mp4:stream_chaoqing.f4v"}],"nextStream":"http://localhost/vbuplayer/main.html"}'
